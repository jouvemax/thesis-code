...
OUTPUT_DIR=/mnt/nas_home/mrgj4/nlvr2_dataset/infusion_experiment/sw/inf_pre_inf_fine
LOGGING_DIR=/mnt/nas_home/mrgj4/nlvr2_dataset/infusion_experiment/sw/inf_pre_inf_fine/logging
