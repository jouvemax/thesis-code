...
PRETRAINED=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_3/zh/seed2/pretrain_cs/ctrl_muniter_base/pytorch_model_24.bin

OUTPUT_DIR=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_3/zh/seed2/pretrain_cs_finetune_cs
LOGGING_DIR=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_3/zh/seed2/pretrain_cs_finetune_cs/logging

# Code-Switching files
CAPTION_TO_POS_TAG_FILE=/mnt/nas_home/mrgj4/wit_dataset/infusion_exp/en_caption_to_pos.pickle
EN_TO_LANG_DICT_FILE=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_3/panlex_dictionaries/en_to_zh_dict.pickle
