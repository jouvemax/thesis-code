...
def parse_args():
    ...
    parser.add_argument("--valid_pos_tags", nargs='+', default=None,
                        help="POS tags to consider for code-switching, e.g. NOUN VERB")
    ...
    parser.add_argument("--en_to_lang_dict_file", default=None, type=str,
                        help="Mapping from (en word, pos tag) -> lang word.")
    # Change amount of fine-tuning data
    parser.add_argument("--number_of_entries", default=None, type=int,
                        help="Number of fine-tuning entries.")
