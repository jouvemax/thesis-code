...
ANNOS=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_1/sw/seed1
WIKIS=/mnt/nas_home/mrgj4/wit_dataset/wikipedia
FEATS=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_1/sw/seed1

OUTPUT_DIR=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_3/xUNITER/sw/seed1/pretrain
LOGGING_DIR=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_3/xUNITER/sw/seed1/pretrain/logging

# Code-Switching files
CAPTION_TO_POS_TAG_FILE=/mnt/nas_home/mrgj4/wit_dataset/infusion_exp/sw_caption_to_pos.pickle
LANG_TO_EN_DICT_FILE=/mnt/nas_home/mrgj4/final_repo/thesis-code/experiment_3/panlex_dictionaries/sw_to_en_dict.pickle
...
python train_wit_wiki.py \
  ...
  --dataroot $WIKIS --lgs sw --lg_sampling_factor 0.7 \
