...
DATA=/mnt/nas_home/mrgj4/wit_dataset/zh_v2
ANNOS=$DATA/captions
WIKIS=$DATA/wikipedia
FEATS=$DATA/features

OUTPUT_DIR=/mnt/nas_home/mrgj4/wit_dataset/zh_v2/pretrain_2
LOGGING_DIR=/mnt/nas_home/mrgj4/wit_dataset/zh_v2/pretrain_2/logging
