...
DATA=/mnt/nas_home/mrgj4/wit_dataset/multiling
ANNOS=$DATA/captions
WIKIS=$DATA/wikipedia
FEATS=$DATA/features

OUTPUT_DIR=/mnt/nas_home/mrgj4/wit_dataset/multiling/pretrain
LOGGING_DIR=/mnt/nas_home/mrgj4/wit_dataset/multiling/pretrain/logging

#source activate /science/image/nlp-datasets/emanuele/envs/mc-bert

# don't forget to change the language --lgs
# change shuffle if not needed in wit_dataset.py
...
python train_wit_wiki.py \
  ...
  --dataroot $WIKIS --lgs sw-ta-tr-id-zh --lg_sampling_factor 0.7 \
